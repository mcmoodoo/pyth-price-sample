...
contract SomeContract {
  ...
  /**
     ...
     */
  function exampleMethod(bytes[] calldata priceUpdate) public payable returns(int64) {
    ...
    // TODO: switch to dai/usd 0xb0948a5e5313200c632b51bb5ca32f6de0d36e9950a942d19751e833f70dabfd
    bytes32 priceFeedId = 0xff61491a931112ddf1bd8147cd1b641375f79f5825126d665480874634fd0ace; // ETH/USD
    PythStructs.Price memory price = pyth.getPriceNoOlderThan(priceFeedId, 60);
    return price.price;
  }

  function dummyNumber() external pure returns (int64){
    return 42;
  }

  function dummySend() public payable returns(int64) {
    return 47;
  }
}
